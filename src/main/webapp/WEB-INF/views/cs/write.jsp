...
<form action="/cs/write" method="post">
	...
	<div class="form-group" id="divCusId" style="float:right; width:49%">
		...
		<input type="text" id="cusId" name="cusId" class="form-control"/>
	</div>
	<div class="form-group" id="divCboardTitle">
		<label for="cBoardTitle">제목</label>
		<input type="text" id="cBoardTitle" name="cBoardTitle" class="form-control" />
	</div>
	<div class="form-group" id="divContent">
		<label for="cBoardContent">본문</label>
		<textarea rows="20" style="width:100%" id="cBoardContent" name="cBoardContent"></textarea>
	</div>
...
<div style="text-align:right;">
	<button class="btn btn-primary" id="btnWrite" data-toggle="modal" data-target="#writeModal">작성</button>
...
<!--         <button type="button" class="btn btn-primary" onclick="location.href='/login/logout'">확인</button> -->
        <a href="/cs/list"><input type="submit" id="btnWrite1" class="btn btn-danger" data-dismiss="modal" value="확인"></a>
